...
const HOST = 'chat-transport.herokuapp.com';
...
class Logger {
  ...
  static reportError(errMessage) {
    Logger.logError(`Error ${errMessage.name}: ${errMessage.message}`);
  }
}

class ChatClient {
  constructor(localVideoId, remoteVideoId, hangUpButtonId) {
  ...
  handleTrackEvent(event) {
    ...
    // TODO: pass these IDS as params to constructor
    document.getElementById(this.remoteVideo).srcObject = event.streams[0];
    document.getElementById(this.hangUpButton).disabled = false;
  }
  ...
  closeVideoCall() {
    var localVideo = document.getElementById(this.localVideo);
    ...
    // TODO: pass ID as arg to constructor
    // Disable the hangup button
    document.getElementById(this.hangUpButton).disabled = true;
  ...
  async invite(evt) {
    ...
    if (this.myPeerConnection) {
      ...
      try {
        ...
        // TODO: pass ID as argument to constructor
        document.getElementById(this.localVideo).srcObject = this.webcamStream;
      } catch(err) {
  ...
  async handleVideoOfferMsg(msg) {
    ...
    if (!this.webcamStream) {
      ...
      // TODO: pass the ID as argument to constructor
      document.getElementById(this.localVideo).srcObject = this.webcamStream;
